"""Potsdam dataset loader for evaluation."""
...
def _index_by_stem(paths: Iterable[Path]):
    ...
    :param paths:
        [
            WindowsPath('D:/data/Potsdam/Exp/img/2_10.png'),
            WindowsPath('D:/data/Potsdam/Exp/img/3_10.png')
        ]
    :return:
        {
            '2_10': WindowsPath('D:/data/Potsdam/Exp/img/2_10.png'),
            '3_10': WindowsPath('D:/data/Potsdam/Exp/img/3_10.png')
        }
    """
...
class PotsdamDataset(Dataset):
    """Potsdam dataset loader.

    The Potsdam dataset contains 6 semantic classes:
        0: background
    ...
    Since the dataset already includes background as class 0, and cls_potsdam.txt
    ...
    def __getitem__(self, idx: int):
        ...
        # Potsdam labels already start from 0 (background=0)
        # and cls_potsdam.txt also includes background, so no shifting needed
