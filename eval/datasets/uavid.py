"""UAVid dataset loader for evaluation."""
...
def _index_by_stem(paths: Iterable[Path]):
    ...
    :param paths:
        [
            WindowsPath('D:/data/UAVid/Exp/img/seq1_00000.png'),
            WindowsPath('D:/data/UAVid/Exp/img/seq2_00000.png')
        ]
    :return:
        {
            'seq1_00000': WindowsPath('D:/data/UAVid/Exp/img/seq1_00000.png'),
            'seq2_00000': WindowsPath('D:/data/UAVid/Exp/img/seq2_00000.png')
        }
    """
...
class UAVidDataset(Dataset):
    """UAVid dataset loader.

    The UAVid dataset contains 8 semantic classes:
    ...
    Since dataset already includes background as class 0, and cls_uavid.txt
    also includes background as first line, no label shifting is needed.
    """
    ...
    def __getitem__(self, idx: int):
        ...
        # UAVid labels already start from 0 (background=0)
        # and cls_uavid.txt also includes background, so no shifting needed
